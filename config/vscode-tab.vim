...
nnoremap <Space>t <Cmd>call <SID>switchEditor(v:count, 'next')<CR>
xnoremap <Space>t <Cmd>call <SID>switchEditor(v:count, 'next')<CR>
nnoremap <Space>T <Cmd>call <SID>switchEditor(v:count, 'prev')<CR>
xnoremap <Space>T <Cmd>call <SID>switchEditor(v:count, 'prev')<CR>